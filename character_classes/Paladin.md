...
**Detect Holy (+0):**  A Paladin can detect holy and unholy spirits and magic, including those inhabiting or possessing other objects/beings. Doing so requires [[Concentration]] and a full minute; so they cannot tell if something is present with a simple glance and people tend to notice when being stared at.

**Prepare Scroll (+0):** Starting at level 2, paladins can create holy spell scrolls and protection scrolls.  See the rules on [magic item creation]() for details.

**Brew Potion (-1):** Starting at level 2, paladins can brew holy water and potions.  See the rules on [magic item creation]() for details.
...
**Deity Disfavor:** Paladins must follow the tenets of their religious order.  Failure to do so may result in loss of class abilities until a proper penance (as determined by their superiors in the order, or the deity itself) is performed.

**Invocation Dice:** As a spellcaster, Paladins have the number of invocation dice indicated on the table below, plus a number of additional dice equal to their Wisdom modifier.  The Paladin may choose how many dice to roll each time they attempt to cast a spell.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center">12+</td><!--Clerical-->
        ...
        <tr>
            ...
            <td align="center">11+</td><!--Competency-->
            <td align="center">11+</td><!--Clerical-->
